...
def main():
    ...
    lya_constrained_policy, lya_constrained_times, lya_constrained_states, lya_constrained_inputs, lya_constrained_pointwise_losses, lya_constrained_potential_norm, lya_constrained_total_loss_history, lya_constrained_control_loss_history = lya_constrained_policy.train_policy(
    ...
    #     node_times, 
    #     lya_times, 
    #     lya_constrained_times, 
    #     node_states, 
    #     lya_states, 
    #     lya_constrained_states, 
    #     timestamp_name, 
    #     plot_epoch
    # )
    plot_x1_t_adversarial(
        ...
        lya_constrained_adversarial_trajectories,
        timestamp_name,
    )
    subplot_streamplot_adversarial(
